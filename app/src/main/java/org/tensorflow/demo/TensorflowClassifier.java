...
class TensorFlowClassifier implements Classifier {
  private static final String TAG = "TensorflowClassifier";
    public static int prev_value = -1;
  ...
  private final String[] class_labels =  {"Wall", "Bicycle", "Bird", "Boat", "Bottle", "Bus", "Car",
          "Cat", "Chair", "Cow", "Table", "Dog", "Horse", "Bike", "Human",
          "Plant", "Sheep", "Sofa", "Train","Display Device"};
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    // Now get the class number.
      ...
      Log.e("item",class_labels[predicted_class]);

      if(prev_value != predicted_class){

          prev_value = predicted_class;

      if(predicted_class == 0 ||predicted_class == 4 ||predicted_class == 6 ||predicted_class == 8 ||predicted_class == 10 ||predicted_class == 14 ||predicted_class == 15 ||predicted_class == 19) {// Now log this prediction.
          ...
          Log.i("hance", "" + predicted_class);
          String predicted_name = class_labels[predicted_class];
          Log.i("hance predicted name ", predicted_name);

          TTS.speak(predicted_name);
